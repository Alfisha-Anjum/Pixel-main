        ...
        <div className="max-w-4xl w-full flex rounded-2xl overflow-hidden shadow-xl">
          ...
          <div className="w-1/2 bg-white p-12 flex flex-col justify-center">
            <div className="mb-8">
              ...
              <p className="text-gray-600">Additional details to personalize your experience</p>
            </div>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className={`w-full pl-10 pr-4 py-3 border ${errors.location ? 'border-red-500' : 'border-gray-300'} rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-orange-500`}
                  />
                </div>
