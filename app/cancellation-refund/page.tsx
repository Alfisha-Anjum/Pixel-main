    ...
    <div className="min-h-screen">
      ...
      <main className="flex-grow">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="rounded-xl md:p-12">
            <h1 className="text-xl md:text-2xl font-semibold text-gray-900 dark:text-white mb-8">
              Cancellation & Refund
            </h1>

            <div className="prose prose-lg max-w-none">
              <p className="text-gray-700 mb-6">
                Our cancellation and refund policy outlines the terms under
              ...
              {/* <div className="bg-orange-50 border-l-4 border-orange-500 p-6 mt-8">
                <p className="text-orange-800 text-sm">
                  For immediate assistance with cancellations or refunds,
                  <br />
