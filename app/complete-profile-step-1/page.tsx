  ...
  return (
    <div className="min-h-screen bg-white flex flex-col">
      <main className="flex-1 flex items-center justify-center py-8 px-4">
        <div className="max-w-4xl w-full flex rounded-2xl overflow-hidden shadow-xl bg-white">
          <div className="w-full md:w-1/2 bg-white p-6 md:p-12 flex flex-col justify-center">
            <div className="mb-8">
              <h1 className="text-3xl md:text-4xl font-bold text-gray-900 mb-2">
                Complete your Profile!
              </h1>
              <p className="text-gray-600">Fill your details to continue</p>
            </div>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    value={phone}
                    disabled
                    className="w-full pl-10 pr-12 py-3 border border-gray-300 rounded-lg bg-gray-100 text-gray-700"
                  />
