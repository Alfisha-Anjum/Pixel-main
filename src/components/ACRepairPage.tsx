        ...
        <div className="grid grid-cols-12 gap-8">
          ...
          <div className="col-span-8 space-y-10">
              ...
              <div className="space-y-4">
                {servicesData.map((service) => (
                  <ServiceCard
                    ...
                    onBook={() => handleAddToCart(service)}
                  />
                ))}
              </div>
            </section>
              ...
              <div className="relative z-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  {customerReviews.map((review) => (
                    <div key={review.id} className="bg-white/10 backdrop-blur-lg rounded-xl p-6 border border-white/20">
            ...
            <section className="mt-20">
              <h2 className="text-2xl font-bold text-center mb-8">We Covered AC Brand</h2>
            ...
            <section className="mt-20 text-center">
              <h2 className="text-2xl font-bold mb-4">AC Repair Service in Raipur</h2>
              <p className="max-w-3xl mx-auto text-gray-600">
                We provide the best AC repair services in Raipur. Our team of experienced technicians is equipped to handle all your AC-related problems, ensuring your comfort during the hot summer months. We are committed to providing fast, reliable, and affordable services.
              </p>
            </section>

            {/* Section 7: Hiring Guide */}
            <section className="mt-20">
              <h2 className="text-2xl font-bold mb-4">Hiring guide for AC Repair service in Raipur</h2>
              <div className="bg-white p-8 rounded-xl shadow-sm">
                <p className="text-gray-600 leading-relaxed">
                  When hiring an AC repair service, it's important to consider several factors to ensure you get the best service possible. Look for companies with a good reputation and positive customer reviews. Verify that they have licensed and experienced technicians. It's also a good idea to get a detailed quote before any work begins to avoid hidden charges. At our company, we pride ourselves on transparency and quality, providing you with a seamless and trustworthy experience from start to finish.
                </p>
              </div>
            </section>
                  ...
                  {[...Array(5)].map((_, i) => (
                    <div key={i} className="border-b last:border-b-0">
                      <button className="w-full flex justify-between items-center py-4">
                        <span className="font-semibold">This is a question?</span>
            ...
            <section className="mt-20">
              <h2 className="text-2xl font-bold mb-8">You May Like Our Other Services</h2>
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                {[
                  ...
                  <div key={service.name} className="bg-white rounded-xl shadow-sm overflow-hidden">
                    <Image
                      src={service.image}
                      alt={service.name}
                      width={300}
                    ...
                    <div className="p-5">
                      ...
                      <button className="mt-4 w-full bg-orange-500 text-white py-2 rounded-lg">Book Now</button>
                    </div>
                  </div>
                ))}
              </div>
                    ...
                    <div key={i} className="bg-white/10 backdrop-blur-md border border-white/20 p-6 rounded-2xl text-white">
                      <div className="flex items-center gap-3 mb-4">
                        ...
                        <div>
                          ...
                          <p className="text-[10px] opacity-60 mt-0.5">1m ago</p>
                        </div>
                      </div>
                      <p className="text-sm leading-relaxed opacity-90 italic">
                        "Lorem ipsum dolor sit amet, consectetur adipiscing elit. In ut id elit dunc. Vestibulum ante ipsum primis in faucibus orci luctus."
                      </p>
                    </div>
                  ))}
                </div>
            ...
            <section>
              ...
              <div className="grid grid-cols-6 gap-6">
                {['VOLTAS', 'DAIKIN', 'SAMSUNG', 'BLUE STAR', 'HITACHI', 'MITSUBISHI'].map(brand => (
                  <div key={brand} className="bg-white border border-gray-100 p-4 rounded-xl shadow-sm flex items-center justify-center h-24 hover:shadow-md transition-shadow">
                    <span className="text-blue-900 font-black italic tracking-tighter text-lg">{brand}</span>
                  </div>
                ))}
              </div>
            </section>
                  ...
                  <div key={i} className="bg-white rounded-3xl overflow-hidden shadow-sm hover:shadow-md transition-shadow">
                    ...
                    <div className="p-5">
                      ...
                      <div className="flex items-center gap-1 text-sm text-gray-500 mb-4">
                        <Star size={14} className="fill-orange-500 text-orange-500" /> {s.rate}
                      </div>
          ...
          <div className="col-span-4">
            <CartPanel 
              ...
              onCheckout={() => router.push('/rate-card')}
            />
          </div>
        </div>
      </div>
