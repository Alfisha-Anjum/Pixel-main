            ...
            >
              ...
              <div style={{ padding: '10px', display: 'flex', flexDirection: 'column', gap: '8px', flex: 1 }}>
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: '4px' }}>
                  <Star style={{ width: '12px', height: '12px', color: '#F97316', fill: '#F97316' }} />
                  <span style={{ fontSize: '13px', color: '#6B7280' }}>{service.rating}</span>
                  <span style={{ fontSize: '13px', color: '#6B7280' }}>({service.reviews})</span>
                </div>
