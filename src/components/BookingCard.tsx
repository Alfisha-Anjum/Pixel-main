...
const BookingCard: React.FC<BookingCardProps> = ({
  ...
  return (
    <div
      ...
      className="bg-white rounded-xl border border-gray-100 shadow-lg p-4 flex flex-col gap-4 hover:shadow-md transition cursor-pointer"
    >
      {/* TOP SECTION */}
      ...
      {isCompleted && (
        <>
          ...
          <button
            ...
            className="w-full py-2 rounded-full bg-gradient-to-r from-orange-500 to-orange-600 text-white font-medium shadow-md hover:opacity-90 transition"
          >
            Create Rework
          </button>
        </>
